...
class Book(db.Model):
    ...
    def __init__(self, title, author, year, isbn, hardcover, pagecount, price, image, user_token, id = ''):
        self.id = self.set_id()
        self.title = title
        self.author = author
        self.year = year
    ...
    def __repr__(self):
        return f'The following vehicle has been added: {self.title}, {self.author}, {self.year}, {self.price}'
...
class BookSchema(ma.Schema):
    class Meta:
        fields = ['id', 'title', 'author', 'year', 'isbn', 'hardcover', 'pagecount', 'price', 'image', 'user_token']
